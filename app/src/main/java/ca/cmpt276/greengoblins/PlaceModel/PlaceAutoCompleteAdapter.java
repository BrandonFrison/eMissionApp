...
public class PlaceAutoCompleteAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            Log.i("PlaceAutoCompleteAd", "Starting autocomplete query for: " + constraint);
            ...
            Log.i("PlaceAutoCompleteAd", "Query completed. Received " + autocompletePredictions.getCount() + " predictions.");


            return DataBufferUtils.freezeAndClose(autocompletePredictions);
        }
        Log.e("PlaceAutoCompleteAd", "Google API client is not connected for autocomplete query.");
        return null;
    }
